    ...
    <DashboardLayout>
      <div className="p-8">
        <div className="max-w-5xl mx-auto space-y-6">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Create B2C Invoice</h1>
            <p className="text-muted-foreground mt-1">Generate a new invoice with AZ series numbering</p>
          </div>
